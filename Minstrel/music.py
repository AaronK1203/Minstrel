...
class Music:
    ...
    def __init__(self,name,path,**kwargs):
        ...
        self.total_time = kwargs.get('total_time',60000)
        self.category = kwargs.get('category','')

    def __str__(self):
        return f'{self.name},{self.path},{self.intervals},{self.bpm},{self.category}'
    ...
    def to_window(self,root):
        ...
        close_button = tk.Button(music_level,text = 'Close',width = 10,height = 1,command = music_level.destroy)
    ...
    def to_canvas(self,root):
        music_canvas = tk.Canvas(root,width = 600,height = 300,bg = 'white')
        ...
        timer_canvas.place(relx = 0.5,rely = 0.4,anchor = tk.CENTER)
        ...
        queue_button = tk.Button(music_canvas,text = 'Queue',width = 5,height = 1,command = lambda: print('Big Chungus'))
        queue_button.place(relx = 0.16,rely = 0.075,anchor = tk.CENTER)
        
        
        close_button = tk.Button(music_canvas,text = 'Close',width = 10,height = 1,command = music_canvas.destroy)
        close_button.place(relx = 0.9,rely = 0.9,anchor = tk.CENTER)
...
if __name__ == '__main__':
    ...
    sauron = Music('Sauron','mp3_files/Sauron.mp3',total_time = 165)
    ...
    mars = Music('Mars, the Bringer of War','mp3_files/Mars-the-Bringer-of-War.mp3',total_time = 425,intervals = [0.0,248.5])

    mars.to_canvas(root).pack()
